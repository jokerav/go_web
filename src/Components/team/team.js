    ...
    return(
        <section className='team'>
            <Container>
                ...
                <p className='team-sub-title'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto, sapiente!</p>
                <ul className='team-list'>
                    <li className='team-item'>
                        <picture>
                            <source  srcSet={`${person1wp2x} 2x, ${person1jpeg2x} 2x, ${person1wp} 1x, ${person1jpeg} 1x`}
                            />
                    ...
                    <li className='team-item'>
                        <picture>
                            <source  srcSet={`${person2wp2x} 2x, ${person2jpeg2x} 2x, ${person2wp} 1x, ${person2jpeg} 1x`}
                            />
                            <img src="#" alt='фото сотрудника' className='team-photo'/>
                        </picture>
                    ...
                    <li className='team-item'>
                        <picture>
                            <source  srcSet={`${person3wp2x} 2x, ${person3jpeg2x} 2x, ${person3wp} 1x, ${person3jpeg} 1x`}
                            />
                            <img src="#" alt='фото сотрудника' className='team-photo'/>
                        </picture>
